...
import io.quee.clef.workflow.api.usecase.factory.workflow.response.stage.CreateWorkflowStageResponse
...
interface StageUseCaseFactory : UseCaseFactory {
    val createStageUseCase: FunctionalUseCase<WorkflowRequest<CreateStageRequest>, CreateWorkflowStageResponse>
}