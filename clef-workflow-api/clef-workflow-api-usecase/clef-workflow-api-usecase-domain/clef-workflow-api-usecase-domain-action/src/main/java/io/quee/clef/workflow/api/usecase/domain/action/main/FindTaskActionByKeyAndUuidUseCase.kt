...
class FindTaskActionByKeyAndUuidUseCase(
    ...
    override fun FindDomainByKeyAndUuidRequest.doProcess(): ResponseAdapter<TaskActionIdentity> {
        val taskActionIdentity = taskActionStoreQuery.findByKey(domainKey)
    ...
    private fun TaskActionIdentity.validate(shouldBeDisabled: Boolean) {
        when (identityStatus) {
