 ...
 */
class StageDetailsUseCase(private val stageDomainUseCaseFactory: StageDomainUseCaseFactory) : ValidationFunctionalUseCase<StageRequest, StageDetailsResponse>() {
    override fun StageRequest.realProcess(): StageDetailsResponse {
