...
class FullWorkflowStructureUseCase(
    ...
    override fun UseCaseRequest.realProcess(): FullWorkflowStructure {
    ...
    private fun TaskActionIdentity.toStructure(): TaskActionStructure {
        return TaskActionStructure(
                uuid, actionKey, actionName, identityStatus, actionDescription, ViewIdentify(destinationTask.uuid, destinationTask.taskKey)
        )
    }
}