...
class StageContextPort {
    ...
    ): StageDomainUseCaseFactory = StageDomainUseCaseFactoryImpl(stageStore, identityAccessValidation, taskDomainUseCaseFactory)
    ...
    fun stageUseCaseFactory(
            ...
            StageUseCaseFactoryImpl(stageStore, stageDomainUseCaseFactory, identityStatusValidation, workflowDomainUseCaseFactory)
}