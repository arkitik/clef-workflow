...
class TaskContextPort {
    ...
    ): StageTaskDomainUseCaseFactory = StageTaskDomainUseCaseFactoryImpl(stageTaskStore, identityAccessValidation, actionDomainUseCaseFactory)
    ...
    ): TaskUseCaseFactory = TaskUseCaseFactoryImpl(stageTaskStore, stageTaskDomainUseCaseFactory, identityStatusValidation, stageDomainUseCaseFactory)
}