 ...
 */
class ElementIdentityCreatorImpl : BaseStoreIdentityCreator<ElementIdentity>(), ElementIdentityCreator {
    ...
    override fun create(): ElementIdentity {
        return Element(
                elementKey, workflow, currentStage, currentTask, identityStatus = identityStatus
        )
    }
