...
interface StageDomainUseCaseFactory : UseCaseFactory {
    val findStageByKeyUseCase: FunctionalUseCase<FindDomainByKeyRequest, ResponseAdapter<StageIdentity>>
    val validateStageExistenceUseCase: CommandUseCase<ExistByKeyRequest>

    val findWorkflowStagesUseCase: FunctionalUseCase<WorkflowDomainRequest, WorkflowStagesResponse>

    val findWorkflowInitialStageUseCase: FunctionalUseCase<WorkflowDomainRequest, ResponseAdapter<StageIdentity>>
}
