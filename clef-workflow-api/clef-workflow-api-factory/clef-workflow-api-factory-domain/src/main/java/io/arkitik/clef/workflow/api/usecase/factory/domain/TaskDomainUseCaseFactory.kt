...
interface TaskDomainUseCaseFactory : UseCaseFactory {
    val findTaskByKeyUseCase: FunctionalUseCase<FindDomainByKeyRequest, ResponseAdapter<TaskIdentity>>
    val validateTaskExistenceUseCase: CommandUseCase<ExistByKeyRequest>

    val findStageTasksUseCase: FunctionalUseCase<StageDomainRequest, StageTasksResponse>
    val findStageInitialTaskUseCase: FunctionalUseCase<StageDomainRequest, ResponseAdapter<TaskIdentity>>
}
