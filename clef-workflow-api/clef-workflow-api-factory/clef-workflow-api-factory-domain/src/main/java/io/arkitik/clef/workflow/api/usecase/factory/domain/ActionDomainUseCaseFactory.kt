 ...
 */
interface ActionDomainUseCaseFactory : UseCaseFactory {
    val findActionByKeyUseCase: FunctionalUseCase<FindDomainByKeyRequest, ResponseAdapter<ActionIdentity>>
    val validateActionExistenceUseCase: CommandUseCase<ExistByKeyRequest>

    val findTaskActionsUseCase: FunctionalUseCase<TaskDomainRequest, TaskActionsResponse>
}
